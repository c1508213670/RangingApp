...
public class DashBoard extends View {
    ...
    private void initText(Canvas canvas) {
        ...
        canvas.drawText("当前角度" , 0, 0, textPaint);
    ...
    private void initRing(Canvas canvas) {
        ...
        int[] colors = {Color.parseColor("#ffffff"), Color.parseColor("#ffffff"), Color.parseColor("#ffffff")};
        ...
        int[] colors2 = {Color.parseColor("#ffffff"),  Color.parseColor("#ffffff")};
